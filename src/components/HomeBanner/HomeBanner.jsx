        ...
        <div className="grid grid-cols-3 w-11/12 mx-auto">
            <div className="col-span-2">
                <div className="carousel w-full">
                    ...
                    <div id="slide2" className="carousel-item relative w-full bg-[url('./assets/slider1.webp')] bg-no-repeat bg-center bg-origin-padding">
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide4" className="btn btn-circle">❮</a>
                            <div className="flex  justify-between gap-x-5">
                                <div id="banner-left" className="flex-1">
                    ...
                    <div id="slide3" className="carousel-item relative w-full bg-[url('./assets/slider1.webp')] bg-no-repeat bg-center bg-origin-padding">
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide4" className="btn btn-circle">❮</a>
                            <div className="flex  justify-between gap-x-5">
                                <div id="banner-left" className="flex-1">
